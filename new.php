        ...
        <main>
            ...
            <section id="api-search">
                <form id="search-form">
                    ...
                    <input type="search" name="search" id="search-books" placeholder="Search bol.com">
                ...
                <div class="prev-next">
                    <button id="prev-ten" class="btn-primary" disabled><i class="fas fa-angle-double-left"></i> Previous 10</button>
                    <button id="next-ten" class="btn-primary" >Next 10 <i class="fas fa-angle-double-right"></i></button>
                </div>
            </section>

            <p class="or">Click on one of the found books to automatically fill the form, or fill it yourself.</p>
